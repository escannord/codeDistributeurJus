...
#define FULL_HEIGHT_CM 18
#define SENSOR_TO_EMPTY_CUP_CM 26.5
#define DENSITE_JUS 1.04
#define DIAMETRE_GOBELET 10
...
void desactiverToutesPompes() {
  ...
  //   sendToAPI(selectedPump, volumeTimer, "completed");
  // }
  // Calcul volume (V = π × r² × h)
  r = DIAMETRE_GOBELET / 2;
  volume = 3.14 * pow(rayon, 2) * niveauJus;
